const { get_congestionDB } = require('../config/db/congestionDB'); // Importer la connexion MongoDB
...
const congestionEvaluation = (data) => {
    ...
    const formattedData = data.map(item => {
        ...
        //     console.log("lane_length: "+lane_length);
        //     console.log("max_speed: "+max_speed);
        //     console.log("vehicles: "+vehicles);
        //     console.log("mean_speed: "+mean_speed);
        //     console.log("density: "+density);
        //     console.log("trafficFlow: "+trafficFlow);
        //     console.log("travel_time: "+travel_time);
        //     console.log("occupancy_rate: "+occupancy_rate);
        //     // console.log("congestion_rate: "+congestion_rate);
        //     console.log("service_level_index: "+service_level_index);
        //     // console.log("lane_capacity: "+lane_capacity);
        //     console.log("veh_count: "+veh_count);
...
// const getLaneCapacity = (vehicles, lane_length) => {
//     if(vehicles.length === 0) return (lane_length *1000)/7.5;
//     const veh_count = vehicles.length;
//     let total_length = 0.0;
//     let total_gap = 0.0;

//     vehicles.forEach(veh => {
//         total_length += parseFloat(veh.length);
//         total_gap += parseFloat(veh.minGap);
//     });

//     const rawCapacity =lane_length / ((total_length +total_gap) / veh_count);
